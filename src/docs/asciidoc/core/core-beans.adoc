...
`accountService`, `userDaoImpl`, `loginController`, and so forth.
	...
	public class Example {
		...
		public void execute() {
			String message = this.messages.getMessage("argument.required",
				new Object [] {"userDaoImpl"}, "Required", Locale.ENGLISH);
			System.out.println(message);
		}
	}
----
...
----
	...
	fun execute() {
		val message = messages.getMessage("argument.required",
				arrayOf("userDaoImpl"), "Required", Locale.ENGLISH)
		println(message)
	}
}
----
...
[literal,subs="verbatim,quotes"]
----
The userDaoImpl argument is required.
----
...
----
	public static void main(final String[] args) {
		...
		String message = resources.getMessage("argument.required",
			new Object [] {"userDaoImpl"}, "Required", Locale.UK);
		System.out.println(message);
	}
----
[source,kotlin,indent=0,subs="verbatim,quotes",role="secondary"]
...
----
	fun main() {
		...
		val message = resources.getMessage("argument.required",
				arrayOf("userDaoImpl"), "Required", Locale.UK)
		println(message)
	}
----
...
[literal,subs="verbatim,quotes"]
----
Ebagum lad, the 'userDaoImpl' argument is required, I say, required.
----
