package com.xc.joy.aspect;

import com.xc.joy.introduction.LittleUniverse;
...
public class ServiceAspect {
	...
	@DeclareParents(value = "com.imooc.controller..*", defaultImpl = com.xc.joy.introduction.impl.LittleUniverseImpl.class)
